    ...
    <footer className="border-t border-border bg-steel text-white">
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            <h4 className="mb-3 text-sm font-semibold uppercase tracking-wider text-cold">Company</h4>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <h4 className="mb-3 text-sm font-semibold uppercase tracking-wider text-cold">Legal</h4>
            <ul className="space-y-2 text-sm">
